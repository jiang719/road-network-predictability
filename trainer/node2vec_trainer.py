...
class Node2VecTrainer(VecTrainer):
    def __init__(self, embed_dim, train_data, city, tester):
        ...
        self.vec_model = Node2Vec(num_walks=500)
    ...
    def save_distmult(self):
        ...
        pickle.dump(obj, open(data_dir + 'data_20200610/node2vec/models/' +
...
if __name__ == "__main__":
    ...
    for city in cities:
        ...
        tester = VecTester(embed_dim=50, test_data=test, city=city, data_dir=data_dir + 'data_20200610/node2vec/')
        trainer = Node2VecTrainer(embed_dim=50, train_data=train, city=city, tester=tester)
        #trainer.prepare_train_embedding(data_dir + 'data_20200610/node2vec/')
        trainer.train_distmult(data_dir=data_dir + 'data_20200610/node2vec/',
                               result_dir=data_dir + 'data_20200610/node2vec/result/')
